	...
	<div class="row">
    	<div class="col-sm-5">
        	<div class="form-group">
                ...
                <div class="col-sm-9">
                	<input type="text" name="courseId" value="${courseInfo.courseId }" class="form-control input-sm" placeholder="请输入编号"/>
                </div>
            </div>
    		...
    		<div class="col-sm-5">
        		<div class="form-group">
        			<label class="col-sm-3 control-label">课程描述</label>
               	    <div class="col-sm-9">
                		<textarea class="form-control" name="courseDesc">"${courseInfo.courseName }"</textarea>
                	</div>
           		</div>	
       		</div>
